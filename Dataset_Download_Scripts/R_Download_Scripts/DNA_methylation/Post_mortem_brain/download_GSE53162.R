...
# Download and stage the public repository inputs used for GSE53162.
...
downloads <- data.frame(
  remote_url = c(
    "https://ftp.ncbi.nlm.nih.gov/geo/series/GSE53nnn/GSE53162/matrix/GSE53162_series_matrix.txt.gz"
  ),
  destination = c(
    "01_Raw_Data/DNA_methylation/Post_mortem_brain/GSE53162/arrays/GSE53162_series_matrix.txt.gz"
  ),
  action = c(
    "none"
  ),
  ...
  expected_sha256 = c(
    "4d19a944d8e6978fca921a0a1f2c4a14682c74577f39d29eb90b029dc3b274c1"
  ),
...
if (!dry_run) {
  ...
  utils::write.csv(do.call(rbind, log_rows), file.path(log_dir, "GSE53162_download_log.csv"), row.names = FALSE, na = "")
  utils::write.csv(checks, file.path(log_dir, "GSE53162_file_check.csv"), row.names = FALSE, na = "")
