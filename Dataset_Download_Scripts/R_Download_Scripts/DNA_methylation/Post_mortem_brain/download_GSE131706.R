...
# Download and stage the public repository inputs used for GSE131706.
...
downloads <- data.frame(
  remote_url = c(
    "https://ftp.ncbi.nlm.nih.gov/geo/series/GSE131nnn/GSE131706/suppl/GSE131706_Matrix_processed.csv.gz",
    "https://ftp.ncbi.nlm.nih.gov/geo/series/GSE131nnn/GSE131706/matrix/GSE131706_series_matrix.txt.gz"
  ),
  destination = c(
    "01_Raw_Data/DNA_methylation/Post_mortem_brain/GSE131706/arrays/GSE131706_Matrix_processed.csv.gz",
    "01_Raw_Data/DNA_methylation/Post_mortem_brain/GSE131706/arrays/GSE131706_series_matrix.txt.gz"
  ),
  action = c(
    "none",
    "none"
  ...
  expected_sha256 = c(
    "bf39e98a5ffdf72460f746bb5da2ed13f8e9c46f8e6ab0dcfc0bee6ce1b53ccc",
    "8543c58678cc28bef37f0197993dbf9ae268ee7e6bc55e697694689ee57cc00a"
  ),
...
if (!dry_run) {
  ...
  utils::write.csv(do.call(rbind, log_rows), file.path(log_dir, "GSE131706_download_log.csv"), row.names = FALSE, na = "")
  utils::write.csv(checks, file.path(log_dir, "GSE131706_file_check.csv"), row.names = FALSE, na = "")
