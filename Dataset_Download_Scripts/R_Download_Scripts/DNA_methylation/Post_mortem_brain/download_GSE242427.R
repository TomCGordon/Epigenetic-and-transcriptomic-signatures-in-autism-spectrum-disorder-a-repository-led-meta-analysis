...
# Download and stage the public repository inputs used for GSE242427.
...
downloads <- data.frame(
  remote_url = c(
    "https://ftp.ncbi.nlm.nih.gov/geo/series/GSE242nnn/GSE242427/matrix/GSE242427_series_matrix.txt.gz"
  ),
  destination = c(
    "01_Raw_Data/DNA_methylation/Post_mortem_brain/GSE242427/arrays/GSE242427_series_matrix.txt.gz"
  ),
  action = c(
    "none"
  ),
  ...
  expected_sha256 = c(
    "19a5a11443e8ce23f67f00f04293d2750eb37611a4ac0082c3f18bf96d2975bb"
  ),
...
if (!dry_run) {
  ...
  utils::write.csv(do.call(rbind, log_rows), file.path(log_dir, "GSE242427_download_log.csv"), row.names = FALSE, na = "")
  utils::write.csv(checks, file.path(log_dir, "GSE242427_file_check.csv"), row.names = FALSE, na = "")
