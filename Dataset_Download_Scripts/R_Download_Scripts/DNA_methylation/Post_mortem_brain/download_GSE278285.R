...
# Download and stage the public repository inputs used for GSE278285.
...
downloads <- data.frame(
  remote_url = c(
    "https://ftp.ncbi.nlm.nih.gov/geo/series/GSE278nnn/GSE278285/suppl/GSE278285_MatrixProcessed_Avg_Beta.txt.gz",
    "https://ftp.ncbi.nlm.nih.gov/geo/series/GSE278nnn/GSE278285/matrix/GSE278285_series_matrix.txt.gz"
  ),
  destination = c(
    "01_Raw_Data/DNA_methylation/Post_mortem_brain/GSE278285/arrays/GSE278285_MatrixProcessed_Avg_Beta.txt.gz",
    "01_Raw_Data/DNA_methylation/Post_mortem_brain/GSE278285/arrays/GSE278285_series_matrix.txt.gz"
  ),
  action = c(
    "none",
    "none"
  ...
  expected_sha256 = c(
    ...
    "e2a77215f6b17f9975d04b5f918ed09041b69e7b6f849a926d0718f694269e5f"
  ),
...
if (!dry_run) {
  ...
  utils::write.csv(do.call(rbind, log_rows), file.path(log_dir, "GSE278285_download_log.csv"), row.names = FALSE, na = "")
  utils::write.csv(checks, file.path(log_dir, "GSE278285_file_check.csv"), row.names = FALSE, na = "")
