...
# Download and stage the public repository inputs used for GSE108785.
...
downloads <- data.frame(
  remote_url = c(
    "https://ftp.ncbi.nlm.nih.gov/geo/series/GSE108nnn/GSE108785/matrix/GSE108785_series_matrix.txt.gz"
  ),
  destination = c(
    "01_Raw_Data/DNA_methylation/Blood_family/GSE108785/GSE108785/GSE108785_series_matrix.txt.gz"
  ),
  action = c(
    "none"
  ),
  ...
  expected_sha256 = c(
    "da7a3d8956ea24c40082f43e1226b1605019651512ff056de218afece7f83e21"
  ),
...
if (!dry_run) {
  ...
  utils::write.csv(do.call(rbind, log_rows), file.path(log_dir, "GSE108785_download_log.csv"), row.names = FALSE, na = "")
  utils::write.csv(checks, file.path(log_dir, "GSE108785_file_check.csv"), row.names = FALSE, na = "")
