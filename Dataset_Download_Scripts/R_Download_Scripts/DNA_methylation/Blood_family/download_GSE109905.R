...
# Download and stage the public repository inputs used for GSE109905.
...
downloads <- data.frame(
  remote_url = c(
    "https://ftp.ncbi.nlm.nih.gov/geo/series/GSE109nnn/GSE109905/matrix/GSE109905_series_matrix.txt.gz"
  ),
  destination = c(
    "01_Raw_Data/DNA_methylation/Blood_family/GSE109905/GSE109905/GSE109905_series_matrix.txt.gz"
  ),
  action = c(
    "none"
  ),
  ...
  expected_sha256 = c(
    "519ae924c7501fdcba97f79e3a6bb2244fabb17480bb851053b27c74430e3117"
  ),
...
if (!dry_run) {
  ...
  utils::write.csv(do.call(rbind, log_rows), file.path(log_dir, "GSE109905_download_log.csv"), row.names = FALSE, na = "")
  utils::write.csv(checks, file.path(log_dir, "GSE109905_file_check.csv"), row.names = FALSE, na = "")
