...
# Download and stage the public repository inputs used for GSE99935.
...
downloads <- data.frame(
  ...
  destination = c(
    "01_Raw_Data/DNA_methylation/Lymphoblastoid_cell_lines/GSE99935/lcl/GSE99935_Matrix_Transposed_normalized_MeDIP_data_bkgd_subtracted.txt.gz"
  ),
  action = c(
    "none"
  ),
  ...
  expected_sha256 = c(
    "3dbe5a31b6db1314bca9c1f84354fa7c3b9ae330a0cef49784a3c96b1d26d006"
  ),
...
if (!dry_run) {
  ...
  utils::write.csv(do.call(rbind, log_rows), file.path(log_dir, "GSE99935_download_log.csv"), row.names = FALSE, na = "")
  utils::write.csv(checks, file.path(log_dir, "GSE99935_file_check.csv"), row.names = FALSE, na = "")
