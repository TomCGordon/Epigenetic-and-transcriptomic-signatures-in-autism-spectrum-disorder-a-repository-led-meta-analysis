...
# Download and stage the public repository inputs used for GSE62098.
...
downloads <- data.frame(
  remote_url = c(
    "https://ftp.ncbi.nlm.nih.gov/geo/series/GSE62nnn/GSE62098/suppl/GSE62098_processedFPKMS.xls.gz"
  ),
  destination = c(
    "01_Raw_Data/Gene_expression/Post_mortem_brain/GSE62098/GSE62098_processedFPKMS.xls.gz"
  ),
  action = c(
    "none"
  ),
  ...
  expected_sha256 = c(
    "f20ec7ae5dc55af04d1cc469002ed7ea497f5e719427201a23da9f5a3ab52bc1"
  ),
...
if (!dry_run) {
  ...
  utils::write.csv(do.call(rbind, log_rows), file.path(log_dir, "GSE62098_download_log.csv"), row.names = FALSE, na = "")
  utils::write.csv(checks, file.path(log_dir, "GSE62098_file_check.csv"), row.names = FALSE, na = "")
