...
# Download and stage the public repository inputs used for GSE28521.
...
downloads <- data.frame(
  remote_url = c(
    "https://ftp.ncbi.nlm.nih.gov/geo/series/GSE28nnn/GSE28521/matrix/GSE28521_series_matrix.txt.gz"
  ),
  destination = c(
    "01_Raw_Data/Gene_expression/Post_mortem_brain/GSE28521/GSE28521_series_matrix.txt.gz"
  ),
  action = c(
    "none"
  ),
  ...
  expected_sha256 = c(
    "538a96042c9cf93f585f1a89ed187a135bb2438d870d32bf0b587dd821f802a8"
  ),
...
if (!dry_run) {
  ...
  utils::write.csv(do.call(rbind, log_rows), file.path(log_dir, "GSE28521_download_log.csv"), row.names = FALSE, na = "")
  utils::write.csv(checks, file.path(log_dir, "GSE28521_file_check.csv"), row.names = FALSE, na = "")
