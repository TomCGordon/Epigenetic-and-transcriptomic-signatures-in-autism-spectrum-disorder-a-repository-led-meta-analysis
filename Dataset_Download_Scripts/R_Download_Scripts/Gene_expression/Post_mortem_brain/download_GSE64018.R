...
# Download and stage the public repository inputs used for GSE64018.
...
downloads <- data.frame(
  remote_url = c(
    "https://ftp.ncbi.nlm.nih.gov/geo/series/GSE64nnn/GSE64018/suppl/GSE64018_countlevel_12asd_12ctl.txt.gz"
  ),
  destination = c(
    "01_Raw_Data/Gene_expression/Post_mortem_brain/GSE64018/GSE64018_countlevel_12asd_12ctl.txt.gz"
  ),
  action = c(
    "none"
  ),
  ...
  expected_sha256 = c(
    "a127c8ac4cc3d10661ae10320db3b06b3490ede616114a5acc77084d82b8e317"
  ),
...
if (!dry_run) {
  ...
  utils::write.csv(do.call(rbind, log_rows), file.path(log_dir, "GSE64018_download_log.csv"), row.names = FALSE, na = "")
  utils::write.csv(checks, file.path(log_dir, "GSE64018_file_check.csv"), row.names = FALSE, na = "")
