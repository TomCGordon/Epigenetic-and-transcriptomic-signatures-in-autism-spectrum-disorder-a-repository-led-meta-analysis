...
# Download and stage the public repository inputs used for GSE102741.
...
downloads <- data.frame(
  remote_url = c(
    "https://ftp.ncbi.nlm.nih.gov/geo/series/GSE102nnn/GSE102741/suppl/GSE102741_log2RPKMcounts.xlsx"
  ),
  destination = c(
    "01_Raw_Data/Gene_expression/Post_mortem_brain/GSE102741/GSE102741_log2RPKMcounts.xlsx"
  ),
  action = c(
    "none"
  ),
  ...
  expected_sha256 = c(
    "153f2dca9bc9de33077fedfb47f31f389401dd0eadf038807f0ad8b845d20cc2"
  ),
...
if (!dry_run) {
  ...
  utils::write.csv(do.call(rbind, log_rows), file.path(log_dir, "GSE102741_download_log.csv"), row.names = FALSE, na = "")
  utils::write.csv(checks, file.path(log_dir, "GSE102741_file_check.csv"), row.names = FALSE, na = "")
