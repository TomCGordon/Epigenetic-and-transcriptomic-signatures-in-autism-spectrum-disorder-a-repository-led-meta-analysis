...
# Download and stage the public repository inputs used for GSE269105.
...
downloads <- data.frame(
  remote_url = c(
    "https://ftp.ncbi.nlm.nih.gov/geo/series/GSE269nnn/GSE269105/suppl/GSE269105_Processed_data_gene_expression_read_and_fpkm.txt.gz"
  ),
  destination = c(
    "01_Raw_Data/Gene_expression/Post_mortem_brain/GSE269105/GSE269105_Processed_data_gene_expression_read_and_fpkm.txt.gz"
  ),
  action = c(
    "none"
  ),
  ...
  expected_sha256 = c(
    "669fb5c4256dac8340b65cac7aa85d02e3603babe24155dd129943303576773c"
  ),
...
if (!dry_run) {
  ...
  utils::write.csv(do.call(rbind, log_rows), file.path(log_dir, "GSE269105_download_log.csv"), row.names = FALSE, na = "")
  utils::write.csv(checks, file.path(log_dir, "GSE269105_file_check.csv"), row.names = FALSE, na = "")
