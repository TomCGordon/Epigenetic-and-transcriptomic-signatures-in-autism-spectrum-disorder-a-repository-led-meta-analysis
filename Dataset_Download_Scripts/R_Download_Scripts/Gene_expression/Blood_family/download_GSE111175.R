...
# Download and stage the public repository inputs used for GSE111175.
...
downloads <- data.frame(
  remote_url = c(
    "https://ftp.ncbi.nlm.nih.gov/geo/series/GSE111nnn/GSE111175/matrix/GSE111175_series_matrix.txt.gz"
  ),
  destination = c(
    "01_Raw_Data/Gene_expression/Blood_family/GSE111175/GSE111175_series_matrix.txt.gz"
  ),
  action = c(
    "none"
  ),
  ...
  expected_sha256 = c(
    "28146e8c309bb71e966c55b2c10266c2e370254a8e12ba2e91ac8fb0f44472ad"
  ),
...
if (!dry_run) {
  ...
  utils::write.csv(do.call(rbind, log_rows), file.path(log_dir, "GSE111175_download_log.csv"), row.names = FALSE, na = "")
  utils::write.csv(checks, file.path(log_dir, "GSE111175_file_check.csv"), row.names = FALSE, na = "")
