...
# Download and stage the public repository inputs used for GSE18123.
...
downloads <- data.frame(
  remote_url = c(
    "https://ftp.ncbi.nlm.nih.gov/geo/series/GSE18nnn/GSE18123/matrix/GSE18123-GPL570_series_matrix.txt.gz",
    "https://ftp.ncbi.nlm.nih.gov/geo/series/GSE18nnn/GSE18123/matrix/GSE18123-GPL6244_series_matrix.txt.gz"
  ),
  destination = c(
    "01_Raw_Data/Gene_expression/Blood_family/GSE18123/GSE18123-GPL570_series_matrix.txt.gz",
    "01_Raw_Data/Gene_expression/Blood_family/GSE18123/GSE18123-GPL6244_series_matrix.txt.gz"
  ),
  action = c(
    "none",
    "none"
  ...
  expected_sha256 = c(
    "1ea2e8ba80b53817e86e3d70089b0e29e3ffe817919123cda6991fdb4ee975f7",
    "da5faca41ea6e98cc8e3524ecf4c4296f7a606f5f78d60eea73fe0800b144d0f"
  ),
...
if (!dry_run) {
  ...
  utils::write.csv(do.call(rbind, log_rows), file.path(log_dir, "GSE18123_download_log.csv"), row.names = FALSE, na = "")
  utils::write.csv(checks, file.path(log_dir, "GSE18123_file_check.csv"), row.names = FALSE, na = "")
