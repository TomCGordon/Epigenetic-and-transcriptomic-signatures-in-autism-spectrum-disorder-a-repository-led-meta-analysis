...
# Download and stage the public repository inputs used for GSE37772.
...
downloads <- data.frame(
  remote_url = c(
    "https://ftp.ncbi.nlm.nih.gov/geo/series/GSE37nnn/GSE37772/matrix/GSE37772_series_matrix.txt.gz"
  ),
  destination = c(
    "01_Raw_Data/Gene_expression/Lymphoblastoid_cell_lines/GSE37772/GSE37772_series_matrix.txt.gz"
  ),
  action = c(
    "none"
  ),
  ...
  expected_sha256 = c(
    "ca1a642a4d427bb39754a5d36f4d5333b773122fd9606064ffb482054889bc4b"
  ),
...
if (!dry_run) {
  ...
  utils::write.csv(do.call(rbind, log_rows), file.path(log_dir, "GSE37772_download_log.csv"), row.names = FALSE, na = "")
  utils::write.csv(checks, file.path(log_dir, "GSE37772_file_check.csv"), row.names = FALSE, na = "")
