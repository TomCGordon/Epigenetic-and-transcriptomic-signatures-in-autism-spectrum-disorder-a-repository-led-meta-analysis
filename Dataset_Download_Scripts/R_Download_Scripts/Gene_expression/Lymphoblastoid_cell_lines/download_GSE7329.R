...
# Download and stage the public repository inputs used for GSE7329.
...
downloads <- data.frame(
  remote_url = c(
    "https://ftp.ncbi.nlm.nih.gov/geo/series/GSE7nnn/GSE7329/matrix/GSE7329_series_matrix.txt.gz"
  ),
  destination = c(
    "01_Raw_Data/Gene_expression/Lymphoblastoid_cell_lines/GSE7329/GSE7329_series_matrix.txt.gz"
  ),
  action = c(
    "none"
  ),
  ...
  expected_sha256 = c(
    "3c545a59b190796749505b3bd25a6e30378b0e48f359ce55866f5818b579d4e5"
  ),
...
if (!dry_run) {
  ...
  utils::write.csv(do.call(rbind, log_rows), file.path(log_dir, "GSE7329_download_log.csv"), row.names = FALSE, na = "")
  utils::write.csv(checks, file.path(log_dir, "GSE7329_file_check.csv"), row.names = FALSE, na = "")
