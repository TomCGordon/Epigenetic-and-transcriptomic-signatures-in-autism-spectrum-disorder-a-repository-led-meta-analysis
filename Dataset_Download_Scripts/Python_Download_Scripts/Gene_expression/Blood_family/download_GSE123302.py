#!/usr/bin/env python3
"""
Download and stage public repository inputs for GSE123302.
...
DOWNLOADS = [{'remote_url': 'https://ftp.ncbi.nlm.nih.gov/geo/series/GSE123nnn/GSE123302/matrix/GSE123302_series_matrix.txt.gz', 'destination': '01_Raw_Data/Gene_expression/Blood_family/GSE123302/GSE123302_series_matrix.txt.gz', 'action': 'none', 'extraction_root': None, 'expected_bytes': 27825398, 'expected_sha256': '8289b441b984218a3b9b9c8a8efc54b7331972306d6db3d9e996775ddec647d2'}]

EXPECTED_FILES = [{'path': '01_Raw_Data/Gene_expression/Blood_family/GSE123302/GSE123302_series_matrix.txt.gz', 'expected_bytes': 27825398, 'expected_sha256': '8289b441b984218a3b9b9c8a8efc54b7331972306d6db3d9e996775ddec647d2'}]
...
def main():
    parser = argparse.ArgumentParser(description="Download repository inputs for GSE123302.")
    ...
    if not args.dry_run and EXPECTED_FILES:
        ...
        pd.DataFrame(log_rows).to_csv(os.path.join(log_dir, "GSE123302_download_log.csv"), index=False)
        checks_df = pd.DataFrame(checks)
        checks_df.to_csv(os.path.join(log_dir, "GSE123302_file_check.csv"), index=False)
        ...
        if not failures.empty:
            ...
            print(f"Dataset GSE123302 staged and verified successfully.")
